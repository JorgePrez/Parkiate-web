        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4><i class="fa fa-angle-right"></i> Resultado </h4>
              <div class="alert alert-danger"><b>Error</b> El código que escaneaste no coincide con ningún servicio.</div>


              <div class="span6">
                  
                  <a href="escanearQR.php" class="btn btn-compose">
                 <!-- <a href="contactformprospecto.html" class="btn btn-compose">  -->

                  <i class="fa fa-qrcode"></i> Escanear otro código</a>
