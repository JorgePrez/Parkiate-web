...
String id1= "-N-yzFejDQpGWS6KccmN";  

String id2="-N-z1WyD84Z1_hHh4nkQ";
...
void loop() {
  ...
  Serial.println(distanceInch1);
    ...
    if (distanceCm1 < 6) {                      //if distance is less than 6cm then on led 
        Serial.println("1:Occupied ");
                  Firebase.setBool(data_park,doc1, false );  // send bool to firebase

  }

  if (distanceCm1 > 6) {                        //if distance is greater than 6cm then off led 
  ...
  Serial.println(distanceInch2);
    ...
    if (distanceCm2 < 6) {                      //if distance is less than 6cm then on led 
        Serial.println("2_Occupied ");
                  Firebase.setBool(data_park,doc2, false );  // send bool to firebase

  }

  if (distanceCm2 > 6) {                        //if distance is greater than 6cm then off led 
