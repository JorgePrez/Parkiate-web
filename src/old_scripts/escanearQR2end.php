        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <div class="alert alert-success"><b>Servicio Finalizado!</b> Se ha registrado la hora de salida y el valor que se le cobrará al usuario. </div>
              ...
              <div class="span6">
                 ...
                 <!-- <a href="contactformprospecto.html" class="btn btn-compose">  -->
                  ...
                  <i class="fa fa-truck"></i> Ver el estado de mis parqueos</a>
