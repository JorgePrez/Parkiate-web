        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" action="formularios/registrar_servicio.php" method="get">
            ...
            <!--  <form class="form-horizontal style-form" method="get"> -->
                ...
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme04" type="submir">EN CASO QUE NO SE POSIBLE ESCANEAR EL QR DEL USUARIO : Presione este boton para finalizar el servicio</button>
                    </div>
