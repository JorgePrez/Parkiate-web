...
$query = "select deteccion_entrada from placas_entrada where id_placa_entrada='$id_placa_corr'";
 ...
 $deteccion_original='';
   ...
   if($deteccion_original == $placa_corr){
    $query= "UPDATE placas_entrada SET error_entrada='N',deteccion_entrada_correcion='NA' WHERE id_placa_entrada='$id_placa_corr'";
...
$query= "UPDATE placas_entrada SET error_entrada='N',deteccion_entrada_correcion='$placa_corr' WHERE id_placa_entrada='$id_placa_corr'";
